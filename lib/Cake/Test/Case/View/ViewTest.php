 ...
 */
	public function testGetTemplate() {
		...
		$expected = CAKE . 'Test' . DS . 'test_app' . DS . 'View' . DS . 'Pages' . DS . 'old.ctp';
		$result = $ThemeView->getViewFileName('home');
		$this->assertEquals($expected, $result);

		$expected = CAKE . 'Test' . DS . 'test_app' . DS . 'View' . DS . 'Themed' . DS . 'TestTheme' . DS . 'Posts' . DS . 'login.ctp';
 ...
 */
	public function testPluginGetTemplate() {
		...
		$expected = CakePlugin::path('TestPlugin') . 'View' . DS . 'Tests' . DS . 'login.ctp';
 ...
 */
	public function testPluginThemedGetTemplate() {
		...
		$ThemeView = new TestThemeView($this->Controller);
		$expected = CAKE . 'Test' . DS . 'test_app' . DS . 'View' . DS . 'Themed' . DS . 'TestTheme' . DS . 'Plugin' . DS . 'TestPlugin' . DS . 'Tests' . DS . 'login.ctp';
 ...
 */
	public function testCamelCasePluginGetTemplate() {
		...
		$pluginPath = CakePlugin::path('TestPlugin');
		$expected = CAKE . 'Test' . DS . 'test_app' . DS . 'Plugin' . DS . 'TestPlugin' . DS . 'View' . DS . 'Tests' . DS . 'login.ctp';
		$result = $View->getViewFileName('index');
		$this->assertEquals($expected, $result);
 ...
 */
	public function testGetViewFileNames() {
		...
		$expected = CAKE . 'Test' . DS . 'test_app' . DS . 'View' . DS . 'Posts' . DS . 'login.ctp';
		...
		$expected = CAKE . 'Test' . DS . 'test_app' . DS . 'View' . DS . 'Pages' . DS . 'page.old.ctp';
 ...
 */
	public function testViewFileName() {
		...
		$result = $View->getViewFileName('index');
		$this->assertRegExp('/Posts(\/|\\\)login.ctp/', $result);

		$result = $View->getViewFileName('TestPlugin.index');
		$this->assertRegExp('/Posts(\/|\\\)login.ctp/', $result);

		$result = $View->getViewFileName('/Pages/home');
		$this->assertRegExp('/Pages(\/|\\\)old.ctp/', $result);
		...
		$this->assertRegExp('/Themed(\/|\\\)TestTheme(\/|\\\)Posts(\/|\\\)login.ctp/', $result);
