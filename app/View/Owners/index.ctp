					...
					<div class="panel-heading">Actions</div>
						<div class="panel-body">
							<ul class="nav nav-pills nav-stacked">
								<li><?php echo $this->Html->link(__('<span class="glyphicon glyphicon-plus"></span>&nbsp;&nbsp;New Owner'), array('action' => 'add'), array('escape' => false)); ?></li>
													</ul>
						</div><!-- end body -->
				</div><!-- end panel -->
			</div><!-- end actions -->
				...
				<?php foreach ($owners as $owner): ?>
					<tr>
						...
						<td class="actions">
							...
							<?php echo $this->Form->postLink('<span class="glyphicon glyphicon-remove"></span>', array('action' => 'delete', $owner['Owner']['id']), array('escape' => false), __('Are you sure you want to delete # %s?', $owner['Owner']['id'])); ?>
						</td>
					</tr>
				<?php endforeach; ?>
				</tbody>
